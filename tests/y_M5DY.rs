...
"#;
    ...
    let v: HashMap<Vec<String>, Vec<String>> = serde_saphyr::from_str(y).expect("failed to parse M5DY");
    assert_eq!(v.len(), 2);
    ...
    assert_eq!(d2, &vec!["2001-07-02".to_string(), "2001-08-12".to_string(), "2001-08-14".to_string()]);
}
