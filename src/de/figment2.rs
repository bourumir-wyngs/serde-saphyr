...
///
/// This enables Figment2 usage like:
///
/// ```rust
/// # #[cfg(feature = "figment2")]
/// # {
/// use figment2::{Figment, providers::Format};
/// use serde::Deserialize;
/// use serde_saphyr::figment2::Yaml;
///
/// #[derive(Deserialize)]
