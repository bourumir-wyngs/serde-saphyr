...
#[cfg(feature = "include")]
use crate::include_stack::IncludeResolver;
...
impl<'a> LiveEvents<'a> {
    ...
    pub(crate) fn from_reader<R: std::io::Read + 'a>(
        ...
        #[cfg(feature = "include")]
        let parser = create_parser_from_reader_input(input, error.clone(), resolver);
        #[cfg(not(feature = "include"))]
...
impl<'a> LiveEvents<'a> {
    ...
    pub(crate) fn from_str(
        ...
        #[cfg(feature = "include")]
        let parser = create_parser_from_str(input, error.clone(), resolver);
        #[cfg(not(feature = "include"))]
